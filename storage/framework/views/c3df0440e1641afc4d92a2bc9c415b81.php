...
<?php $component->withAttributes([]); ?>
                ...
                <a href="<?php echo e(route('wallets.index')); ?>">Wallets</a>
...
<?php endif; ?>
            ...
            <div class="bg-white shadow-xl sm:rounded-lg p-6">
                <form method="POST" action="<?php echo e(route('wallets.store')); ?>">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="exid" required class="border p-2 w-full rounded">
                            ...
                            <?php $__currentLoopData = $exchanges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exchange): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($exchange->exid); ?>"><?php echo e($exchange->name); ?></option>
                    ...
                    <div class="mt-4">
                        ...
                        <a href="<?php echo e(route('wallets.index')); ?>" class="bg-gray-500 text-white px-4 py-2 rounded ml-2">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
...
<?php endif; ?>
<?php /**PATH /home/newmoon/Documents/Projects/WebhookHandler/TradingView/LARAVEL-TradingView-WebhookHandler/resources/views/wallets/create.blade.php ENDPATH**/ ?>