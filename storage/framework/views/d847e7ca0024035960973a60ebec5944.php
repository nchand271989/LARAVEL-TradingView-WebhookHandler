...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table-toolbar','data' => ['searchAction' => ''.e(route('wallets.index')).'','searchPlaceholder' => 'Search Wallets...','showButton' => false,'buttonLabel' => 'Add Wallet','buttonRoute' => ''.e(route('wallets.create')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['searchAction' => ''.e(route('wallets.index')).'','searchPlaceholder' => 'Search Wallets...','showButton' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'buttonLabel' => 'Add Wallet','buttonRoute' => ''.e(route('wallets.create')).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table','data' => ['columns' => [
                        ...
                        'status' => 'Status',
                        'topup' => 'Top Up',
                    ],'actions' => [''],'items' => $records,'editRoute' => '','deleteRoute' => '','topUpRoute' => 'wallets.topup','topUpWalletKey' => 'wltid']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes(['columns' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
                        ...
                        'status' => 'Status',
                        'topup' => 'Top Up',
                    ]),'actions' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['']),'items' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($records),'editRoute' => '','deleteRoute' => '','topUpRoute' => 'wallets.topup','topUpWalletKey' => 'wltid']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH /home/newmoon/Documents/Projects/WebhookHandler/TradingView/LARAVEL-TradingView-WebhookHandler/resources/views/wallets/index.blade.php ENDPATH**/ ?>