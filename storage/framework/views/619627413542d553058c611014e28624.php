...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table-toolbar','data' => ['searchAction' => ''.e(route('currencies.index')).'','searchPlaceholder' => 'Search currencies...','buttonLabel' => 'Add Currency','buttonRoute' => ''.e(route('currencies.create')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['searchAction' => ''.e(route('currencies.index')).'','searchPlaceholder' => 'Search currencies...','buttonLabel' => 'Add Currency','buttonRoute' => ''.e(route('currencies.create')).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table','data' => ['columns' => [
                        ...
                        'shortcode' => 'Code',
                        'status' => 'Status',
                    ],'items' => $records,'statusToggleRoute' => 'currencies.toggleStatus','detachRelations' => ['exchanges'],'key' => 'curid']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes(['columns' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
                        ...
                        'shortcode' => 'Code',
                        'status' => 'Status',
                    ]),'items' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($records),'statusToggleRoute' => 'currencies.toggleStatus','detachRelations' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['exchanges']),'key' => 'curid']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH /home/newmoon/Documents/Projects/WebhookHandler/TradingView/LARAVEL-TradingView-WebhookHandler/resources/views/currencies/index.blade.php ENDPATH**/ ?>