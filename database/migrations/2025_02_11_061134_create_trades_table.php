...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('trades', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('webhook_id');       /** Foreign key to link to the 'webhooks' table, indicating the webhook associated with the trade. */
            $table->unsignedBigInteger('strategy_id');      /** Foreign key to link to the 'strategies' table, indicating the strategy used in the trade. */
            $table->unsignedBigInteger('exchange_id');      /** Foreign key to link to the 'exchanges' table, indicating the exchange involved in the trade. */
            $table->unsignedBigInteger('currency_id');      /** Foreign key to link to the 'currencies' table, indicating the currency used in the trade. */
            $table->unsignedBigInteger('rule_id');          /** Foreign key to link to the 'rules' table, indicating the trading rule applied. */
            $table->unsignedBigInteger('wallet_id');        /** Foreign key to link to the 'wallets' table, indicating the wallet that executed the trade. */
