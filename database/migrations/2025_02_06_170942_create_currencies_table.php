...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('currencies', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('createdBy')->nullable();        /** Foreign key to store the ID of the user who created this currency entry */ 
            $table->unsignedBigInteger('lastUpdatedBy')->nullable();    /** Foreign key to store the ID of the user who last updated this currency entry */ 
