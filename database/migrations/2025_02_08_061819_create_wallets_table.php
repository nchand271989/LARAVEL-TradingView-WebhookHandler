...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('wallets', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('webhook_id');           /** Foreign key referencing the 'webhid' in the 'webhooks' table, establishing a relationship between the wallet and a webhook. */
            $table->unsignedBigInteger('rule_id');              /** Foreign key referencing the 'rid' in the 'rules' table, establishing a relationship between the wallet and a specific rule. */
