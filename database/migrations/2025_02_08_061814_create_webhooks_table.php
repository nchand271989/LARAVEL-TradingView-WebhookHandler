...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('webhooks', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('strategy_id');          /** Foreign key referencing 'stratid' from the 'strategies' table, indicating which strategy the webhook is associated with */ 
            ...
            $table->unsignedBigInteger('createdBy');            /** Foreign key referencing 'id' from the 'users' table, indicating the user who created the webhook */
            $table->unsignedBigInteger('lastUpdatedBy');        /** Foreign key referencing 'id' from the 'users' table, indicating the user who last updated the webhook */
